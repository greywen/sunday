...
import { Button, Col, DatePicker, Form, Input, InputNumber, message, Row, Space } from "antd"
...
const InformForm = (props: IProps) => {
  ...
  return (
    <Form
      ...
      initialValues={defaultValue && { ...defaultValue, date: [moment(defaultValue?.date[0], 'YYYY-MM-DD'), moment(defaultValue?.date[1], 'YYYY-MM-DD')] }}
    >
      <Form.Item
        label="标题"
        name="title"
      ...
      <MyEditor html={html} onchange={(res) => { setHtml(res) }} />
